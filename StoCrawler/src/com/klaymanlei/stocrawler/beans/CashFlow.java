...
public class CashFlow implements FinancialStatements {

	private final Map<String, Double> map = new LinkedHashMap<String, Double>();
	private final String code;
	private final Date date;

	public CashFlow(String code, Date date) {
		super();
	...
	public int getReportKind() {
		return Constants.REPORT_CASH_FLOW;
	}

	@Override
	public String toString() {
		return "CashFlow [code=" + code + ", date=" + date + ", map=" + map
				+ "]";
	}
